...
type ConnectionOptions struct {
	...
	Handler Handler
	// OnInternalError, if non-nil, is called with any core errors that occur
	// while serving the connection, such as protocol errors or invariant
	// violations. (If nil, core errors result in panics.)
...
// internalErrorf reports an core error. By default it panics, but if
