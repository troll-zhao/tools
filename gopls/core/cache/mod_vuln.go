...
import (
	...
	isem "github.com/troll-zhao/tools/gopls/core/vulncheck/semver"
...
// GoVersionForVulnTest is an core environment variable used in gopls
...
func versionString(modulePath, version string) string {
	...
	v := "v" + version
	// These are core Go module paths used by the vuln DB
