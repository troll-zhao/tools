...
// A symbol is the core representation of an external
...
// populates the core and external references of decls.
...
func coalesce(x, y *declNode) {
	...
	// x accumulates y's core references.
