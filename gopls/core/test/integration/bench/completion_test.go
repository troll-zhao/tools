...
func BenchmarkStructCompletion(b *testing.B) {
	file := "core/lsp/cache/session.go"
...
func BenchmarkImportCompletion(b *testing.B) {
	const file = "core/lsp/source/completion/completion.go"
	benchmarkCompletion(completionBenchOptions{
		file:           file,
		locationRegexp: `go\/()`,
...
func BenchmarkFuncDeepCompletion(b *testing.B) {
	file := "core/lsp/source/completion/completion.go"
	fileContent := `
func (c *completer) _() {
...
var completionTests = []completionTest{
	{
		"tools",
		"selector",
		"core/lsp/source/completion/completion2.go",
		`
package completion
