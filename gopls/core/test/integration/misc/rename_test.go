...
`
	Run(t, files, func(t *testing.T, env *Env) {
		env.OpenFile("lib/core/x/a.go")
		env.Rename(env.RegexpSearch("lib/core/x/a.go", "x"), "utils")

		// Check if the new package name exists.
		env.RegexpSearch("lib/a.go", "mod.com/lib/core/utils")
		env.RegexpSearch("lib/a.go", "utils.B")

		// Check if the test package is renamed
		env.RegexpSearch("lib/core/utils/a.go", "package utils")
		...
		// Check if the new package name exists.
		env.RegexpSearch("lib1/a.go", "package lib1")
		env.RegexpSearch("lib1/a.go", "mod.com/lib1/core/utils")
