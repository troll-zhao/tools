...
// Copier is a tool to automate copy of govulncheck's core files.
//
//   - copy golang.org/x/vuln/core/osv/ to osv
//   - copy golang.org/x/vuln/core/govulncheck/ to govulncheck
package main
...
func main() {
	...
	cfg := rewrite{
		...
		srcImportPath: "golang.org/x/vuln/core",
		dstImportPath: currentPackagePath(),
	}

	copyFiles("osv", filepath.Join(srcDir, "core", "osv"), cfg)
	copyFiles("govulncheck", filepath.Join(srcDir, "core", "govulncheck"), cfg)
}
